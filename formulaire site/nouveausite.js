...
const toiletteA = document.getElementById("toiletteA");
const toiletteB = document.getElementById("toiletteB");
...
formulaire.addEventListener("submit", (e) => {
  ...
  const exposi = document.getElementById("exposition").value;
  ...
  const positionGps = document.getElementById("positionGps");
  const positionGps2 = document.getElementById("positionGps2");
